...
- Same host id, separate IPC namespaces: `SHM` verdict for a pair whose messages are all lost — [#101](https://github.com/atinfinity/fastdds_transport_viz/issues/101)
