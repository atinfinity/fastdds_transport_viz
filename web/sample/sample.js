...
window.TRANSPORT_VIZ_SAMPLE = {
 ...
 "reason_code_descriptions": {
  ...
  "stats-writer-instance-limit-suspected": "The writer's participant reports traffic to 10 or more locators but none to this reader. The Fast DDS statistics DataWriter keeps the default resource limit of 10 instances (one per destination locator), so counters for further locators are never published.",
 ...
 "reason_code_remedies": {
  ...
  "stats-writer-instance-limit-suspected": "Start the observed nodes with FASTDDS_DEFAULT_PROFILES_FILE pointing at this package's config/statistics.xml (a data_writer profile per statistics alias whose <resourceLimitsQos> sets max_instances to 0).",
 ...
 "stats": {
  ...
  "participants_with_stats": [
   ...
   "01.0f.40.ec.85.00.55.f9.00.00.00.00"
  ],
  "physical": {
   "01.0f.40.ec.35.00.5d.09.00.00.00.00": {
