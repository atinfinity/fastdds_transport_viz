...
void usage()
{
  std::cout <<
    ...
    "  --all              include services/actions and non-ROS DDS topics; a service or an\n"
    "                     action is one SERVICE / ACTION row per client-server pair, not\n"
    "                     its raw rq/ and rr/ topics\n"
